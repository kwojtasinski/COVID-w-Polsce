...
def test_transform_poland_data():
    ...
    assert _2022.shape == pd.read_json("covid_w_polsce/tests/standard_data/2022.json").shape
    assert _2021.shape == pd.read_json("covid_w_polsce/tests/standard_data/2021.json").shape
    assert _2020.shape == pd.read_json("covid_w_polsce/tests/standard_data/2020.json").shape
